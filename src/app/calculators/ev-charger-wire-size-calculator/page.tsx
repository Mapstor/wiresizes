...
export const metadata: Metadata = {
  title: 'EV Charger Wire Size — NEC 310.16',
  description: 'Wire size for Level 2 EV chargers (32A, 40A, 48A, 80A). NEC 310.16 with 125% continuous-load factor. NEMA 14-50 vs hardwire decision.',
